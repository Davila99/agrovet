...
import AudioTime from '../../atoms/chat/AudioTime';
import Waveform from '../../atoms/chat/Waveform';
...
export default function WhatsAppAudioBubble({
  ...
  return (
    <Box sx={{ 
      ...
      gap: 1, 
      p: '6px 8px', 
      borderRadius: fromMe ? '7.5px 7.5px 1px 7.5px' : '7.5px 7.5px 7.5px 1px',
      boxShadow: '0 1px 0.5px rgba(0,0,0,0.13)', 
      bgcolor: fromMe ? '#DCF8C6' : '#FFFFFF', 
      maxWidth: '100%', 
      width: 'auto',
      border: fromMe ? 'none' : '1px solid rgba(0,0,0,0.08)',
    }}>
      {/* Avatar con icono de micrófono cuando fromMe es true */}
      {avatarUrl && fromMe && (
        <Box sx={{ position: 'relative', display: 'inline-block' }}>
          ...
          >
            <MicNoneIcon sx={{ fontSize: 12, color: '#fff' }} />
          </Box>
        </Box>
      )}
