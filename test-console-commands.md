...
## Opción 1: Copiar y pegar el script completo
...
Si prefieres, puedes cargar el script desde el archivo `test-user-editing.js`:

```javascript
// En la consola del navegador:
const script = document.createElement('script');
script.src = '/test-user-editing.js';
...
2. **Obtener perfil** - Obtiene el perfil del usuario autenticado
3. **Obtener usuario por ID** - Verifica que se puede obtener el usuario
4. **Verificar perfil de especialista** - Comprueba si existe el perfil
5. **PATCH al perfil** - Intenta actualizar con PATCH
6. **PUT al perfil** - Si PATCH falla, intenta PUT
7. **CREATE perfil** - Si no existe, intenta crearlo
8. **Actualizar usuario** - Prueba actualizar datos básicos del usuario

Todos los resultados se mostrarán en la consola con detalles completos.
