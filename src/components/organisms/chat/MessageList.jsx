    ...
    return (
      <Box
        sx={{
          flex: 1,
          overflowY: "auto",
          // Add bottom padding on small screens so messages aren't hidden
          // behind the fixed ChatInput. Adjust value if ChatInput height changes.
          pb: { xs: "72px", md: 0 },
          p: 1,
